...
TEST_CASE("Compute the absolute difference between two instants", "[Duration]")
{
	SECTION("With the same second")
	{
		...
		{
			Ck::Instant lhs = Ck::Instant::EpochSeconds(0, 32'000'000);
			Ck::Instant rhs = Ck::Instant::EpochSeconds(0, 16'000'000);
	...
	SECTION("With a different second")
	{
		...
		{
			Ck::Instant lhs = Ck::Instant::EpochSeconds(10, 999'500'000);
			Ck::Instant rhs = Ck::Instant::EpochSeconds(11, 500'000);
