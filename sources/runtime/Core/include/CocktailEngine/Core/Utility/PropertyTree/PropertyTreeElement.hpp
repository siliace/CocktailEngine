#ifndef COCKTAILENGINE_CORE_UTILITY_PROPERTYTREE_PROPERTYTREEELEMENT_HPP
#define COCKTAILENGINE_CORE_UTILITY_PROPERTYTREE_PROPERTYTREEELEMENT_HPP
    ...
    public:
        ...
        NodeType<Data>* InsertBefore(Node* where, const String& name, const NodeType<Data>& node)
        {
        	...
        	else
            {
                ...
                clone->SetNextSibling(Move(mFirstChild));
                mFirstChild = Move(clone);
            }
...
#endif // COCKTAILENGINE_CORE_UTILITY_PROPERTYTREE_PROPERTYTREEELEMENT_HPP
