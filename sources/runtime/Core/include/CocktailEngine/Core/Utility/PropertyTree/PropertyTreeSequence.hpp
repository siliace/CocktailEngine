#ifndef COCKTAILENGINE_CORE_UTILITY_PROPERTYTREE_PROPERTYTREESEQUENCE_HPP
#define COCKTAILENGINE_CORE_UTILITY_PROPERTYTREE_PROPERTYTREESEQUENCE_HPP

#include <CocktailEngine/Core/Array.hpp>
#include <CocktailEngine/Core/Utility/TranslatorCast.hpp>
#include <CocktailEngine/Core/Utility/PropertyTree/PropertyTreeNode.hpp>
...
namespace Ck
{
    ...
    public:
        ...
        NodeType<Data>* Add(const NodeType<Data>& node)
        {
            ...
            Node* inserted = mChildren.Emplace(Move(clone)).Get();
...
#endif // COCKTAILENGINE_CORE_UTILITY_PROPERTYTREE_PROPERTYTREESEQUENCE_HPP
