#ifndef COCKTAILENGINE_CORE_UTILITY_FUNCTIONTRAITS_HPP
#define COCKTAILENGINE_CORE_UTILITY_FUNCTIONTRAITS_HPP

#include <tuple>

#include <CocktailEngine/Core/Utility/ParameterPack.hpp>
...
#endif // COCKTAILENGINE_CORE_UTILITY_FUNCTIONTRAITS_HPP
