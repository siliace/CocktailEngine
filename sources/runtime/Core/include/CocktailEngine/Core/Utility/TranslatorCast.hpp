#ifndef COCKTAILENGINE_CORE_UTILITY_TRANSLATORCAST_HPP
#define COCKTAILENGINE_CORE_UTILITY_TRANSLATORCAST_HPP

#include <CocktailEngine/Core/String.hpp>
#include <CocktailEngine/Core/Utility/Any.hpp>
...
namespace Ck
{
	...
	struct StringParseIntegerTranslator
	{
		...
		Optional<OutputType> operator()(InputType value) const noexcept
		{
			...
			return Optional<String>::Of(Move(result));
		}
	};
...
#endif // COCKTAILENGINE_CORE_UTILITY_TRANSLATORCAST_HPP
