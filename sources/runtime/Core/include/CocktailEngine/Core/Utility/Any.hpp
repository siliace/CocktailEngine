#ifndef COCKTAILENGINE_CORE_UTILITY_ANY_HPP
#define COCKTAILENGINE_CORE_UTILITY_ANY_HPP
...
namespace Ck
{
	 ...
	 */
	class COCKTAILENGINE_CORE_API Any
	{
	public:
		...
		{
			mHolder = MakeUnique<AnyHolder<T>>(Move(value));
		}
		...
		{
			mHolder = MakeUnique<AnyHolder<T>>(InPlace, Forward<Args>(args)...);
		}
...
#endif // COCKTAILENGINE_CORE_UTILITY_ANY_HPP