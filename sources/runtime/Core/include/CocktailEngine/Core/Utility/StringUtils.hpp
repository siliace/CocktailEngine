#ifndef COCKTAILENGINE_CORE_UTILITY_CHARACTERS_HPP
#define COCKTAILENGINE_CORE_UTILITY_CHARACTERS_HPP

#include <CocktailEngine/Core/Utility/CharUtils.hpp>
...
#endif // COCKTAILENGINE_CORE_UTILITY_CHARACTERS_HPP
