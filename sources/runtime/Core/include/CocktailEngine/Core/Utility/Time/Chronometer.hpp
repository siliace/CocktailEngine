#ifndef COCKTAILENGINE_CORE_UTILITY_TIME_CHRONOMETER_HPP
#define COCKTAILENGINE_CORE_UTILITY_TIME_CHRONOMETER_HPP
...
namespace Ck
{
     ...
     */
    class COCKTAILENGINE_CORE_API Chronometer
    {
    public:
...
#endif // COCKTAILENGINE_CORE_UTILITY_TIME_CHRONOMETER_HPP
