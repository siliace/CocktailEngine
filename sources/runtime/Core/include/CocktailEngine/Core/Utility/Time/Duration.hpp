#ifndef COCKTAILENGINE_CORE_UTILITY_TIME_DURATION_HPP
#define COCKTAILENGINE_CORE_UTILITY_TIME_DURATION_HPP
...
namespace Ck
{
     ...
     * \see TimeUnit
     */
    class COCKTAILENGINE_CORE_API Duration
    {
    public:
     ...
     */
    COCKTAILENGINE_CORE_API bool operator==(const Duration& lhs, const Duration& rhs);
     ...
     */
    COCKTAILENGINE_CORE_API Duration operator+(const Duration& lhs, const Duration& rhs);
     ...
     */
    COCKTAILENGINE_CORE_API Duration& operator+=(Duration& lhs, const Duration& rhs);
...
#endif // COCKTAILENGINE_CORE_UTILITY_TIME_DURATION_HPP
