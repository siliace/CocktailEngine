#ifndef COCKTAILENGINE_CORE_UTILITY_TIME_TIMEUNIT_HPP
#define COCKTAILENGINE_CORE_UTILITY_TIME_TIMEUNIT_HPP
...
namespace Ck
{
     ...
     */
    class COCKTAILENGINE_CORE_API TimeUnit
    {
    public:
...
#endif // COCKTAILENGINE_CORE_UTILITY_TIME_TIMEUNIT_HPP
