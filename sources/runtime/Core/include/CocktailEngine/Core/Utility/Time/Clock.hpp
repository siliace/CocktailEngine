#ifndef COCKTAILENGINE_CORE_UTILITY_TIME_CLOCK_HPP
#define COCKTAILENGINE_CORE_UTILITY_TIME_CLOCK_HPP
...
namespace Ck
{
     ...
     */
    class COCKTAILENGINE_CORE_API Clock
    {
    public:
...
#endif // COCKTAILENGINE_CORE_UTILITY_TIME_CLOCK_HPP
