#ifndef COCKTAILENGINE_CORE_SIGNAL_DETAIL_SLOTCONTAINER_HPP
#define COCKTAILENGINE_CORE_SIGNAL_DETAIL_SLOTCONTAINER_HPP
...
#endif // COCKTAILENGINE_CORE_SIGNAL_DETAIL_SLOTCONTAINER_HPP
