#ifndef COCKTAILENGINE_CORE_MATH_VOLUME_CYLINDER_HPP
#define COCKTAILENGINE_CORE_MATH_VOLUME_CYLINDER_HPP
...
#endif // COCKTAILENGINE_CORE_MATH_VOLUME_CYLINDER_HPP
