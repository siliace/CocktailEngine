#ifndef COCKTAILENGINE_CORE_MATH_VECTOR_VECTOR3_HPP
#define COCKTAILENGINE_CORE_MATH_VECTOR_VECTOR3_HPP

#include <CocktailEngine/Core/Extent3D.hpp>
#include <CocktailEngine/Core/Math/Angle.hpp>
...
namespace Ck
{
	...
	public:
	    ...
	    using ElementType = typename Vector<Vector3, T, 3>::ElementType;

		static constexpr unsigned int Size = Vector<Vector3, T, 3>::Size;
...
#endif // COCKTAILENGINE_CORE_MATH_VECTOR_VECTOR3_HPP
