#ifndef COCKTAILENGINE_CORE_MATH_VECTOR_VECTOR2_HPP
#define COCKTAILENGINE_CORE_MATH_VECTOR_VECTOR2_HPP

#include <CocktailEngine/Core/Extent2D.hpp>
#include <CocktailEngine/Core/Math/Vector/Vector.hpp>
...
namespace Ck
{
	...
	public:
		...
		static constexpr unsigned int Size = Vector<Vector2, T, 2>::Size;
...
#endif // COCKTAILENGINE_CORE_MATH_VECTOR_VECTOR2_HPP
