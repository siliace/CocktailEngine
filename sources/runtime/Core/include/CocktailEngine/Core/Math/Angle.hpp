#ifndef COCKTAILENGINE_CORE_MATH_ANGLE_HPP
#define COCKTAILENGINE_CORE_MATH_ANGLE_HPP

#include <CocktailEngine/Core/Cocktail.hpp>
#include <CocktailEngine/Core/Math/Constants.hpp>
...
#endif // COCKTAILENGINE_CORE_MATH_ANGLE_HPP
