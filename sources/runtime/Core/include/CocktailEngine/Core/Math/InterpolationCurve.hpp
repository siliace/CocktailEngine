#ifndef COCKTAILENGINE_CORE_MATH_INTERPOLATIONCURVE_HPP
#define COCKTAILENGINE_CORE_MATH_INTERPOLATIONCURVE_HPP

#include <map>

#include <CocktailEngine/Core/Array.hpp>
#include <CocktailEngine/Core/Math/Interpolation.hpp>
    ...
    public:
        ...
        public:
            ...
            InterpolationCurve Get()
            {
                ...
                return InterpolationCurve(Move(keyFrames), mInterpolationFunction);
            }
        ...
        void AddKeyFrame(const KeyType& key, const ValueType& value)
        {
            if (!mKeyFrames.IsEmpty())
            {
                ...
                {
                    mKeyFrames[index] = Move(keyFrame);
                }
                else
                {
                    mKeyFrames.AddAt(index, Move(keyFrame));
                }
            }
            else
            {
...
#endif // COCKTAILENGINE_CORE_MATH_INTERPOLATIONCURVE_HPP
