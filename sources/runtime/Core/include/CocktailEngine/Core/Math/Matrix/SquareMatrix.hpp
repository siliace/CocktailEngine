#ifndef COCKTAILENGINE_CORE_MATH_MATRIX_SQUAREMATRIX_HPP
#define COCKTAILENGINE_CORE_MATH_MATRIX_SQUAREMATRIX_HPP

#include <CocktailEngine/Core/Math/Matrix/Matrix.hpp>
...
#endif // COCKTAILENGINE_CORE_MATH_MATRIX_SQUAREMATRIX_HPP
