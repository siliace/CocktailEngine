#ifndef COCKTAILENGINE_CORE_ASSET_ASSETIMPORTER_HPP
#define COCKTAILENGINE_CORE_ASSET_ASSETIMPORTER_HPP

#include <CocktailEngine/Core/IO/Input/Stream/BufferedInputStream.hpp>
...
#endif // COCKTAILENGINE_CORE_ASSET_ASSETIMPORTER_HPP
