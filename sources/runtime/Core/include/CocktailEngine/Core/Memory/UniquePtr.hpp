#ifndef COCKTAILENGINE_CORE_MEMORY_UNIQUEPTR_HPP
#define COCKTAILENGINE_CORE_MEMORY_UNIQUEPTR_HPP
...
namespace Ck
{
    ...
    UniquePtr<T, AllocatorAwareDeleter<T, TAllocator>> MakeUniqueWithAllocator(typename TAllocator::template ForType<T>& allocator, TArgs&&... args)
    {
        ...
        ObjectMemoryUtils::Construct(pointer, Forward<TArgs>(args)...);
...
#endif // COCKTAILENGINE_CORE_MEMORY_UNIQUEPTR_HPP
