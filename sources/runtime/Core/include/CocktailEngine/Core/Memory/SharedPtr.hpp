#ifndef COCKTAILENGINE_CORE_MEMORY_SHAREDPTR_HPP
#define COCKTAILENGINE_CORE_MEMORY_SHAREDPTR_HPP
...
namespace Ck
{
    ...
    public:
        ...
        SharedPtr(U* pointer, TDeleter&& deleter) :
            ...
            mRefCounter(nullptr)
        {
            UniquePtr<U, std::decay_t<TDeleter>> unique(pointer, Forward<TDeleter>(deleter));
            if (unique)
                mRefCounter = new Detail::RemoteRefCounter<U, TDeleter>(unique.Get(), unique.GetDeleter());
    ...
    private:
        ...
        friend class Detail::SharedObjectPoolBase;
    ...
    {
        Detail::MakeSharedRefCounter<T>* refCounter = new Detail::MakeSharedRefCounter<T>(Forward<TArgs>(args)...);
...
#endif // COCKTAILENGINE_CORE_MEMORY_SHAREDPTR_HPP
