#ifndef COCKTAILENGINE_CORE_MEMORY_MEMORY_HPP
#define COCKTAILENGINE_CORE_MEMORY_MEMORY_HPP
...
namespace Ck
{
     ...
     */
    class COCKTAILENGINE_CORE_API Memory
    {
    public:
...
#endif // COCKTAILENGINE_CORE_MEMORY_MEMORY_HPP