#ifndef COCKTAILENGINE_CORE_MEMORY_ALLOCATOR_SIZEDHEAPALLOCATOR_HPP
#define COCKTAILENGINE_CORE_MEMORY_ALLOCATOR_SIZEDHEAPALLOCATOR_HPP

#include <CocktailEngine/Core/Memory/Memory.hpp>
#include <CocktailEngine/Core/Memory/SizeType.hpp>
...
namespace Ck
{
	...
	public:
	    ...
	    struct ForType
	    {
	        ...
	        {
	            return static_cast<T*>(AllocationHandler::Allocate(size * sizeof(T), alignof(T)));
	        }
...
#endif // COCKTAILENGINE_CORE_MEMORY_ALLOCATOR_SIZEDHEAPALLOCATOR_HPP
