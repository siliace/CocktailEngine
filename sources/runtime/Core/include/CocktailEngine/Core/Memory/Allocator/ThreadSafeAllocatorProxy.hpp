#ifndef COCKTAILENGINE_CORE_MEMORY_ALLOCATOR_THREADSAFEALLOCATORPROXY_HPP
#define COCKTAILENGINE_CORE_MEMORY_ALLOCATOR_THREADSAFEALLOCATORPROXY_HPP
...
namespace Ck
{
     ...
     * internal lock.
     */
    class COCKTAILENGINE_CORE_API ThreadSafeAllocatorProxy : public MemoryAllocator
    {
    public:
...
#endif // COCKTAILENGINE_CORE_MEMORY_ALLOCATOR_THREADSAFEALLOCATORPROXY_HPP
