#ifndef COCKTAILENGINE_CORE_MEMORY_ALLOCATOR_SIZEDLINEARALLOCATOR_HPP
#define COCKTAILENGINE_CORE_MEMORY_ALLOCATOR_SIZEDLINEARALLOCATOR_HPP
...
namespace Ck
{
    ...
    public:
        ...
        private:
            ...
            alignas(T) Byte mInlineData[sizeof(T) * InlineSize]; /*!< Inline storage buffer */
...
#endif // COCKTAILENGINE_CORE_MEMORY_ALLOCATOR_SIZEDLINEARALLOCATOR_HPP
