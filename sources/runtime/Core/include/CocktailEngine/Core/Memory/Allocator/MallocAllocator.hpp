#ifndef COCKTAILENGINE_CORE_MEMORY_ALLOCATOR_MALLOCALLOCATOR_HPP
#define COCKTAILENGINE_CORE_MEMORY_ALLOCATOR_MALLOCALLOCATOR_HPP
...
namespace Ck
{
     ...
     */
    class COCKTAILENGINE_CORE_API MallocAllocator : public MemoryAllocator
    {
    public:
...
#endif //COCKTAILENGINE_CORE_MEMORY_ALLOCATOR_MALLOCALLOCATOR_HPP
