#ifndef COCKTAILENGINE_CORE_MEMORY_ALLOCATOR_MALLOCALLOCATIONHANDLER_HPP
#define COCKTAILENGINE_CORE_MEMORY_ALLOCATOR_MALLOCALLOCATIONHANDLER_HPP
...
namespace Ck
{
     ...
     */
    class COCKTAILENGINE_CORE_API MallocAllocationHandler : public ServiceFacade<MallocAllocator>
    {
    public:
...
#endif // COCKTAILENGINE_CORE_MEMORY_ALLOCATOR_MALLOCALLOCATIONHANDLER_HPP
