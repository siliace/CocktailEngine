#ifndef COCKTAILENGINE_CORE_DATATYPE_HPP
#define COCKTAILENGINE_CORE_DATATYPE_HPP
...
namespace Ck
{
	 ...
	 */
	class COCKTAILENGINE_CORE_API DataType
	{
	public:
	 ...
	 */
	COCKTAILENGINE_CORE_API bool operator==(const DataType& lhs, const DataType& rhs);
...
#endif // COCKTAILENGINE_CORE_DATATYPE_HPP
