#ifndef COCKTAILENGINE_CORE_STRING_HPP
#define COCKTAILENGINE_CORE_STRING_HPP

#include <CocktailEngine/Core/Array.hpp>
#include <CocktailEngine/Core/Utility/Encoding/Encoders.hpp>
#include <CocktailEngine/Core/Utility/StringFormater.hpp>
...
namespace Ck
{
    ...
    public:
        ...
        {
            return BasicStringView(GetData() + start, std::min(length, GetLength() - start));
        }
    ...
    public:
        ...
        {
            BasicString string;
            StringFormater<CharType>::FormatTo(string.mCharacters, format.GetData(), Forward<Args>(args)...);
    ...
    struct Formatter<BasicStringView<TEncoding>, void>
    {
        ...
        {
            const CharType* data = value.GetData();
            return data != nullptr ? data : GetEmptyFormatArgument<CharType>();
        }
    };
...
#endif // COCKTAILENGINE_CORE_STRING_HPP
