#ifndef COCKTAILENGINE_CORE_IO_INPUT_INPUTACCUMULATOR_HPP
#define COCKTAILENGINE_CORE_IO_INPUT_INPUTACCUMULATOR_HPP
...
#endif // COCKTAILENGINE_CORE_IO_INPUT_INPUTACCUMULATOR_HPP
