#ifndef COCKTAILENGINE_CORE_IO_INPUT_READER_LINEREADER_HPP
#define COCKTAILENGINE_CORE_IO_INPUT_READER_LINEREADER_HPP
...
namespace Ck
{
    ...
    public:
        ...
        Optional<BasicString<EncodingType, TAllocator>> ReadLine(bool ignoreEmptyLines)
        {
            ...
            return Optional<BasicString<EncodingType, TAllocator>>::Of(Move(line));
        }
...
#endif // COCKTAILENGINE_CORE_IO_INPUT_READER_LINEREADER_HPP
