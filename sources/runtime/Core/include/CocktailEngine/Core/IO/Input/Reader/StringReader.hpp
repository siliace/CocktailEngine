#ifndef COCKTAILENGINE_CORE_IO_INPUT_READER_STRINGREADER_HPP
#define COCKTAILENGINE_CORE_IO_INPUT_READER_STRINGREADER_HPP
...
#endif // COCKTAILENGINE_CORE_IO_INPUT_READER_STRINGREADER_HPP
