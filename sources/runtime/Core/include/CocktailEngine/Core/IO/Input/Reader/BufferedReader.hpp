#ifndef COCKTAILENGINE_CORE_IO_INPUT_READER_BUFFEREDREADER_HPP
#define COCKTAILENGINE_CORE_IO_INPUT_READER_BUFFEREDREADER_HPP
...
#endif // COCKTAILENGINE_CORE_IO_INPUT_READER_BUFFEREDREADER_HPP
