#ifndef COCKTAILENGINE_CORE_IO_INPUT_READER_READER_HPP
#define COCKTAILENGINE_CORE_IO_INPUT_READER_READER_HPP
...
#endif // COCKTAILENGINE_CORE_IO_INPUT_READER_READER_HPP
