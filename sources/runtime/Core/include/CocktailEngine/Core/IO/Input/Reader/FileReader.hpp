#ifndef COCKTAILENGINE_CORE_IO_INPUT_READER_FILEREADER_HPP
#define COCKTAILENGINE_CORE_IO_INPUT_READER_FILEREADER_HPP
...
#endif // COCKTAILENGINE_CORE_IO_INPUT_READER_FILEREADER_HPP
