#ifndef COCKTAILENGINE_CORE_IO_INPUT_STREAM_INPUTSTREAM_HPP
#define COCKTAILENGINE_CORE_IO_INPUT_STREAM_INPUTSTREAM_HPP
...
#endif // COCKTAILENGINE_CORE_IO_INPUT_STREAM_INPUTSTREAM_HPP
