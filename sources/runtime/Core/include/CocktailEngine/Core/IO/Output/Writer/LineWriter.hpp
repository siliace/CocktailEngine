#ifndef COCKTAILENGINE_CORE_IO_OUTPUT_WRITER_LINEWRITER_HPP
#define COCKTAILENGINE_CORE_IO_OUTPUT_WRITER_LINEWRITER_HPP

#include <CocktailEngine/Core/IO/Output/Writer/Writer.hpp>
...
namespace Ck
{
    ...
    public:
        ...
        {
            Write(BasicString<TEncoding>::Format(format, Forward<TArgs>(args)...));
        }
        ...
        {
            WriteLine(BasicString<TEncoding>::Format(format, Forward<TArgs>(args)...));
        }
...
#endif // COCKTAILENGINE_CORE_IO_OUTPUT_WRITER_LINEWRITER_HPP
