#ifndef COCKTAILENGINE_CORE_STATICARRAY_HPP
#define COCKTAILENGINE_CORE_STATICARRAY_HPP
...
namespace Ck
{
    ...
    {
        return StaticArray<E, sizeof...(TArgs)>(Forward<TArgs>(args)...);
    }
}

#endif // COCKTAILENGINE_CORE_STATICARRAY_HPP
