#ifndef COCKTAILENGINE_CORE_APPLICATION_SERVICEFACADE_HPP
#define COCKTAILENGINE_CORE_APPLICATION_SERVICEFACADE_HPP
...
#endif // COCKTAILENGINE_CORE_APPLICATION_SERVICEFACADE_HPP
