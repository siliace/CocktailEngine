#ifndef COCKTAILENGINE_CORE_SYSTEM_NETWORK_SOCKETPOLLER_HPP
#define COCKTAILENGINE_CORE_SYSTEM_NETWORK_SOCKETPOLLER_HPP
...
namespace Ck
{
	 ...
	 * \brief 
	 */
	class COCKTAILENGINE_CORE_API SocketPoller
	{
	public:
...
#endif // COCKTAILENGINE_CORE_SYSTEM_NETWORK_SOCKETPOLLER_HPP
