#ifndef COCKTAILENGINE_CORE_SYSTEM_NETWORK_SOCKET_HPP
#define COCKTAILENGINE_CORE_SYSTEM_NETWORK_SOCKET_HPP
...
namespace Ck
{
	 ...
	 * \brief 
	 */
	class COCKTAILENGINE_CORE_API Socket
	{
	public:
...
#endif // COCKTAILENGINE_CORE_SYSTEM_NETWORK_SOCKET_HPP
