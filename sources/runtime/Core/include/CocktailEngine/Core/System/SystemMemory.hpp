#ifndef COCKTAILENGINE_CORE_SYSTEM_SYSTEMMEMORY_HPP
#define COCKTAILENGINE_CORE_SYSTEM_SYSTEMMEMORY_HPP
...
namespace Ck
{
     ...
     */
    class COCKTAILENGINE_CORE_API SystemMemory
    {
    public:
...
#endif // COCKTAILENGINE_CORE_SYSTEM_SYSTEMMEMORY_HPP
