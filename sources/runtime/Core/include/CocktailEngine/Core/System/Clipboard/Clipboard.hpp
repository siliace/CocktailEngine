#ifndef COCKTAILENGINE_CORE_SYSTEM_CLIPBOARD_CLIPBOARD_HPP
#define COCKTAILENGINE_CORE_SYSTEM_CLIPBOARD_CLIPBOARD_HPP

#include <CocktailEngine/Core/Application/ServiceFacade.hpp>
#include <CocktailEngine/Core/System/Clipboard/ClipboardService.hpp>
...
namespace Ck
{
	 ...
	 */
	class COCKTAILENGINE_CORE_API Clipboard : public ServiceFacade<ClipboardService>
	{
	public:
...
#endif // COCKTAILENGINE_CORE_SYSTEM_CLIPBOARD_CLIPBOARD_HPP
