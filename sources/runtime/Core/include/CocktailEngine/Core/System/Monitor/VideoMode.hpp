#ifndef COCKTAILENGINE_CORE_SYSTEM_MONITOR_VIDEOMODE_HPP
#define COCKTAILENGINE_CORE_SYSTEM_MONITOR_VIDEOMODE_HPP
...
#endif // COCKTAILENGINE_CORE_SYSTEM_MONITOR_VIDEOMODE_HPP
