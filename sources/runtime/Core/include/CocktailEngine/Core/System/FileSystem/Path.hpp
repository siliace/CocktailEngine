#ifndef COCKTAILENGINE_CORE_SYSTEM_FILESYSTEM_PATH_HPP
#define COCKTAILENGINE_CORE_SYSTEM_FILESYSTEM_PATH_HPP
...
namespace Ck
{
     ...
     */
    class COCKTAILENGINE_CORE_API Path
    {
    public:
...
#endif // COCKTAILENGINE_CORE_SYSTEM_FILESYSTEM_PATH_HPP
