#ifndef COCKTAILENGINE_CORE_SYSTEM_FILESYSTEM_URI_HPP
#define COCKTAILENGINE_CORE_SYSTEM_FILESYSTEM_URI_HPP
...
namespace Ck
{
     ...
     */
    class COCKTAILENGINE_CORE_API URI
    {
    public:
...
{
	template <>
	struct COCKTAILENGINE_CORE_API hash<Ck::URI>
	{
		size_t operator()(const Ck::URI& uri) const noexcept;
	};
}
#endif // COCKTAILENGINE_CORE_SYSTEM_FILESYSTEM_URI_HPP
