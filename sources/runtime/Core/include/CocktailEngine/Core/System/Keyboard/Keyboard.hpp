#ifndef COCKTAILENGINE_CORE_SYSTEM_KEYBOARD_KEYBOARD_HPP
#define COCKTAILENGINE_CORE_SYSTEM_KEYBOARD_KEYBOARD_HPP

#include <CocktailEngine/Core/Application/ServiceFacade.hpp>
#include <CocktailEngine/Core/System/Keyboard/KeyboardService.hpp>
...
namespace Ck
{
     ...
     */
    class COCKTAILENGINE_CORE_API Keyboard : public ServiceFacade<KeyboardService>
    {
    public:
...
#endif // COCKTAILENGINE_CORE_SYSTEM_KEYBOARD_KEYBOARD_HPP