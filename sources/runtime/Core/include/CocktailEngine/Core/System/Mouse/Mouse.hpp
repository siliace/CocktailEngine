#ifndef COCKTAILENGINE_CORE_SYSTEM_MOUSE_MOUSE_HPP
#define COCKTAILENGINE_CORE_SYSTEM_MOUSE_MOUSE_HPP
...
namespace Ck
{
     ...
     */
    class COCKTAILENGINE_CORE_API Mouse : public ServiceFacade<MouseService>
    {
    public:
...
#endif // COCKTAILENGINE_CORE_SYSTEM_MOUSE_MOUSE_HPP