#ifndef COCKTAILENGINE_CORE_SYSTEM_CONCURRENCY_THREADLOCAL_HPP
#define COCKTAILENGINE_CORE_SYSTEM_CONCURRENCY_THREADLOCAL_HPP

#include <functional>

#include <CocktailEngine/Core/System/Concurrency/ThreadLocalStorage.hpp>
...
namespace Ck
{
    ...
    public:
        ...
        ThreadLocal& operator=(ThreadLocal&& other) noexcept
        {
            ...
            LockGuard lg1(mValueLock);
            LockGuard lg2(other.mValueLock);

            mFactory = Move(other.mFactory);
        ...
        T* Get()
        {
            ...
            LockGuard lg(mValueLock);
            mValues.Add(Move(value));
    ...
    private:
        ...
        mutable Mutex mValueLock; /*!< Mutex to protect access to mValues */
    };
}

#endif // COCKTAILENGINE_CORE_SYSTEM_CONCURRENCY_THREADLOCAL_HPP
