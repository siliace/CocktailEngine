#ifndef COCKTAILENGINE_CORE_SYSTEM_CONCURRENCY_THREAD_HPP
#define COCKTAILENGINE_CORE_SYSTEM_CONCURRENCY_THREAD_HPP
...
namespace Ck
{
     ...
     * \endcode
     */
    class COCKTAILENGINE_CORE_API Thread : public ServiceFacade<ThreadManager>
    {
    public:
        ...
        /**
         * \brief Waits until the given predicate returns \c false
         * 
...
#endif // COCKTAILENGINE_CORE_SYSTEM_CONCURRENCY_THREAD_HPP
