#ifndef COCKTAILENGINE_CORE_SYSTEM_CONCURRENCY_AFFINITYMASKBUILDER_HPP
#define COCKTAILENGINE_CORE_SYSTEM_CONCURRENCY_AFFINITYMASKBUILDER_HPP
...
namespace Ck
{
     ...
     */
    class COCKTAILENGINE_CORE_API AffinityMaskBuilder
    {
    public:
...
#endif // COCKTAILENGINE_CORE_SYSTEM_CONCURRENCY_AFFINITYMASKBUILDER_HPP
