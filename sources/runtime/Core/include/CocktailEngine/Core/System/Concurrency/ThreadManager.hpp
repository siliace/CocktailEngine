#ifndef COCKTAILENGINE_CORE_SYSTEM_CONCURRENCY_THREADMANAGER_HPP
#define COCKTAILENGINE_CORE_SYSTEM_CONCURRENCY_THREADMANAGER_HPP
...
#endif // COCKTAILENGINE_CORE_SYSTEM_CONCURRENCY_THREADMANAGER_HPP
