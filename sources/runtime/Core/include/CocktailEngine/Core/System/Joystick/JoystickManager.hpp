#ifndef COCKTAILENGINE_CORE_SYSTEM_JOYSTICK_JOYSTICKMANAGER_HPP
#define COCKTAILENGINE_CORE_SYSTEM_JOYSTICK_JOYSTICKMANAGER_HPP
...
#endif // COCKTAILENGINE_CORE_SYSTEM_JOYSTICK_JOYSTICKMANAGER_HPP
