#ifndef COCKTAILENGINE_CORE_HASHSET_HPP
#define COCKTAILENGINE_CORE_HASHSET_HPP

#include <CocktailEngine/Core/HashTable.hpp>
...
namespace Ck
{
    ...
    public:
        ...
        bool Add(TElement&& element)
        {
            ...
            return Base::PutEntryIfMissing(key, Move(element));
        }
        ...
        {
            TElement element(Forward<TArgs>(args)...);
            return Add(Move(element));
        }
...
#endif // COCKTAILENGINE_CORE_HASHSET_HPP
