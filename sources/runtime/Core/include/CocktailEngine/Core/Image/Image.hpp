#ifndef COCKTAILENGINE_CORE_IMAGE_IMAGE_HPP
#define COCKTAILENGINE_CORE_IMAGE_IMAGE_HPP

#include <CocktailEngine/Core/Image/ImageView.hpp>
...
namespace Ck
{
     ...
     */
    class COCKTAILENGINE_CORE_API Image
    {
    public:
...
#endif // COCKTAILENGINE_CORE_IMAGE_IMAGE_HPP
