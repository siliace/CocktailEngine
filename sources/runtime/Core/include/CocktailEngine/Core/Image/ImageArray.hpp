#ifndef COCKTAILENGINE_CORE_IMAGE_IMAGEARRAY_HPP
#define COCKTAILENGINE_CORE_IMAGE_IMAGEARRAY_HPP
...
namespace Ck
{
     ...
     */
    class COCKTAILENGINE_CORE_API ImageArray
    {
    public:
...
#endif // COCKTAILENGINE_CORE_IMAGE_IMAGEARRAY_HPP
