#ifndef COCKTAILENGINE_CORE_IMAGE_IMAGEVIEW_HPP
#define COCKTAILENGINE_CORE_IMAGE_IMAGEVIEW_HPP

#include <CocktailEngine/Core/Image/ImageInfo.hpp>
#include <CocktailEngine/Core/Utility/ByteArrayView.hpp>
...
namespace Ck
{
     ...
     */
    class COCKTAILENGINE_CORE_API ImageView
    {
    public:
...
#endif // COCKTAILENGINE_CORE_IMAGE_IMAGEVIEW_HPP
