#ifndef COCKTAILENGINE_CORE_IMAGE_IMAGEINFO_HPP
#define COCKTAILENGINE_CORE_IMAGE_IMAGEINFO_HPP

#include <CocktailEngine/Core/Color.hpp>
#include <CocktailEngine/Core/Image/GammaSpace.hpp>
#include <CocktailEngine/Core/Image/ImageRawFormat.hpp>
...
namespace Ck
{
     ...
     */
    class COCKTAILENGINE_CORE_API ImageInfo
    {
    public:
...
#endif // COCKTAILENGINE_CORE_IMAGE_IMAGEINFO_HPP
