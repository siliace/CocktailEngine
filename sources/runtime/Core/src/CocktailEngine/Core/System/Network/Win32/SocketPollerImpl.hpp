#ifndef COCKTAILENGINE_CORE_SYSTEM_NETWORK_WIN32_SOCKETPOLLERIMPL_HPP
#define COCKTAILENGINE_CORE_SYSTEM_NETWORK_WIN32_SOCKETPOLLERIMPL_HPP
...
#endif // COCKTAILENGINE_CORE_SYSTEM_NETWORK_WIN32_SOCKETPOLLERIMPL_HPP
