...
namespace Ck::Detail::Xlib
{
        ...
        mResizing(false)
    {
        ...
        App::Invoke([&](AtomManager* atomManager) {
            ...
            if (style != Flags<WindowStyle>::None())
            {
                    ...
                    if (size != mLastSize)
                    {
                        ...
                        else
                        {
                            if (!mResizing)
                            {
                                ...
                                resizingStartEvent.Source = this;
