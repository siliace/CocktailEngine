#ifndef COCKTAILENGINE_CORE_SYSTEM_MOUSE_WIN32_MOUSESERVICE_HPP
#define COCKTAILENGINE_CORE_SYSTEM_MOUSE_WIN32_MOUSESERVICE_HPP
...
#endif // COCKTAILENGINE_CORE_SYSTEM_MOUSE_WIN32_MOUSESERVICE_HPP
