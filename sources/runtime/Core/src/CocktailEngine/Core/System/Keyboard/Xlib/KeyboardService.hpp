#ifndef COCKTAILENGINE_CORE_SYSTEM_KEYBOARD_XLIB_KEYBOARDSERVICE_HPP
#define COCKTAILENGINE_CORE_SYSTEM_KEYBOARD_XLIB_KEYBOARDSERVICE_HPP
...
#endif // COCKTAILENGINE_CORE_SYSTEM_KEYBOARD_XLIB_KEYBOARDSERVICE_HPP
