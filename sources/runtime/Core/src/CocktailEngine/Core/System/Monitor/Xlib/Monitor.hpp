#ifndef COCKTAILENGINE_CORE_SYSTEM_MONITOR_XLIB_MONITOR_HPP
#define COCKTAILENGINE_CORE_SYSTEM_MONITOR_XLIB_MONITOR_HPP
...
#endif // COCKTAILENGINE_CORE_SYSTEM_MONITOR_XLIB_MONITOR_HPP
