#ifndef COCKTAILENGINE_CORE_SYSTEM_CLIPBOARD_WIN32_CLIPBOARDSERVICE_HPP
#define COCKTAILENGINE_CORE_SYSTEM_CLIPBOARD_WIN32_CLIPBOARDSERVICE_HPP
...
#endif // COCKTAILENGINE_CORE_SYSTEM_CLIPBOARD_WIN32_CLIPBOARDSERVICE_HPP
