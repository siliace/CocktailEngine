...
#include <CocktailEngine/Graphic/Geometry/Vertex/VertexAttribute.hpp>
...
namespace Ck
{
	 ...
	 * \brief 
	 */
	class COCKTAILENGINE_GRAPHIC_API VertexLayout
	{
	public:

		class COCKTAILENGINE_GRAPHIC_API Builder
		{
		public:
