...
#include <CocktailEngine/Core/Image/ImageArray.hpp>
#include <CocktailEngine/Core/Memory/SharedPtr.hpp>

#include <CocktailEngine/Graphic/Material/MipMaps/MipMapLevel.hpp>
...
namespace Ck
{
	 ...
	 * \brief 
	 */
	class COCKTAILENGINE_GRAPHIC_API MipMaps
	{
	public:
