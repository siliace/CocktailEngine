...
namespace Ck
{
     ...
     */
    class COCKTAILENGINE_GRAPHIC_API BindingDomainInterface
    {
    public:
    ...
    private:
        ...
        {
            BindingSlot Slot = InvalidBindingSlot; /*!< The binding slot index */
     ...
     */
    class COCKTAILENGINE_GRAPHIC_API MaterialProgramInterface
    {
    public:
