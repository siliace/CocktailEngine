...
#include <CocktailEngine/Graphic/Scene/Camera/Controller/CameraController.hpp>

namespace Ck
{
	class COCKTAILENGINE_GRAPHIC_API FreeFlyCameraViewController : public CameraController
	{
	public:
