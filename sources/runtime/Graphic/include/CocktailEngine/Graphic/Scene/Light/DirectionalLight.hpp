...
namespace Ck
{
	 ...
	 * \brief 
	 */
	class COCKTAILENGINE_GRAPHIC_API DirectionalLight : public Light
	{
	public:
		 ...
		 * \return 
		 */
		static DirectionalLight* Create(SharedPtr<Scene> scene, String name, Vector3<float> direction, LinearColor color,  float intensity = 100.f);
