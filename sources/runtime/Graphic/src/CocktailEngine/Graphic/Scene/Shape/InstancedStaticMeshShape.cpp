...
#include <CocktailEngine/Graphic/Scene/Shape/InstancedStaticMeshShape.hpp>
#include <CocktailEngine/Graphic/Rendering/Queue/InstancedStaticMeshRecordInfo.hpp>
...
namespace Ck
{
    InstancedStaticMeshShape::InstancedStaticMeshShape(GraphicEngine& graphicEngine, const Array<Transformation>& instances, SharedPtr<Mesh> mesh, const Array<SharedPtr<Material>>& materials) :
        StaticMeshShape(graphicEngine, Move(mesh), materials),
