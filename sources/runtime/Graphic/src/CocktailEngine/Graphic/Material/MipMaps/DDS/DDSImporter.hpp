...
#include <CocktailEngine/Core/Asset/AssetImporter.hpp>
...
namespace Ck
{
	...
	public:
		 ...
		 * \return 
		 */
		SharedPtr<MipMaps> LoadFromPath(const Path& path, const MipMapsImportParameters& parameters) override;
		 ...
		 * \return 
		 */
		SharedPtr<MipMaps> LoadFromStream(InputStream<>& inputStream, const MipMapsImportParameters& parameters) override;
