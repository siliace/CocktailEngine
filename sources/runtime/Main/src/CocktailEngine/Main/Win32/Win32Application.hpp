#ifndef COCKTAILENGINE_MAIN_WIN32_WIN32APPLICATION_HPP
#define COCKTAILENGINE_MAIN_WIN32_WIN32APPLICATION_HPP
...
namespace Ck::Main::Win32
{
    ...
    public:
         ...
         */
        [[noreturn]] void Abort(unsigned int exitCode) override;
...
#endif // COCKTAILENGINE_MAIN_WIN32_WIN32APPLICATION_HPP
