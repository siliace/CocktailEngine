#ifndef COCKTAILENGINE_RENDERER_RENDERDEVICEOBJECT_HPP
#define COCKTAILENGINE_RENDERER_RENDERDEVICEOBJECT_HPP
...
#endif // COCKTAILENGINE_RENDERER_RENDERDEVICEOBJECT_HPP
