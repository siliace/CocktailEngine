#ifndef COCKTAILENGINE_RENDERER_TEXTURE_TEXTUREVIEW_HPP
#define COCKTAILENGINE_RENDERER_TEXTURE_TEXTUREVIEW_HPP
...
#endif // COCKTAILENGINE_RENDERER_TEXTURE_TEXTUREVIEW_HPP
