#ifndef COCKTAILENGINE_RENDERER_TEXTURE_HPP
#define COCKTAILENGINE_RENDERER_TEXTURE_HPP
...
namespace Ck::Renderer
{
     ...
     */
    COCKTAILENGINE_RENDERER_API unsigned int ComputeTextureLevelCount(const Extent3D<unsigned int>& baseSize);
     ...
     */
    COCKTAILENGINE_RENDERER_API Extent3D<unsigned int> ComputeTextureLevelSize(const Extent3D<unsigned int>& baseSize, unsigned int level);
}

#endif // COCKTAILENGINE_RENDERER_TEXTURE_HPP
