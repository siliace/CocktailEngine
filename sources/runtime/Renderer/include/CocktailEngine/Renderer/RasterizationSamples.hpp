#ifndef COCKTAILENGINE_RENDERER_RASTERIZATIONSAMPLES_HPP
#define COCKTAILENGINE_RENDERER_RASTERIZATIONSAMPLES_HPP
...
#endif // COCKTAILENGINE_RENDERER_RASTERIZATIONSAMPLES_HPP
