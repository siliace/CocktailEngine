#ifndef COCKTAILENGINE_RENDERER_COMMNAD_COMMANDLISTCREATEINFO_HPP
#define COCKTAILENGINE_RENDERER_COMMNAD_COMMANDLISTCREATEINFO_HPP
...
#endif // COCKTAILENGINE_RENDERER_COMMNAD_COMMANDLISTCREATEINFO_HPP
