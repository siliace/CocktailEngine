#ifndef COCKTAILENGINE_RENDERER_PIXELFORMAT_HPP
#define COCKTAILENGINE_RENDERER_PIXELFORMAT_HPP
...
namespace Ck
{
     ...
     */
    class COCKTAILENGINE_RENDERER_API PixelFormat
    {
    public:
...
#endif // COCKTAILENGINE_RENDERER_PIXELFORMAT_HPP
