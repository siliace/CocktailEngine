#ifndef COCKTAILENGINE_RENDERER_RENDERTARGET_FRAMEBUFFERCREATEINFO_HPP
#define COCKTAILENGINE_RENDERER_RENDERTARGET_FRAMEBUFFERCREATEINFO_HPP
...
namespace Ck::Renderer
{
    ...
    struct FramebufferCreateInfo
    {
         ...
         */
        SharedPtr<TextureView> ColorAttachments[Framebuffer::MaxColorAttachmentCount];
         ...
         */
        SharedPtr<TextureView> DepthStencilAttachment = nullptr;
...
#endif // COCKTAILENGINE_RENDERER_RENDERTARGET_FRAMEBUFFERCREATEINFO_HPP
