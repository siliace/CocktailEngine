#ifndef COCKTAILENGINE_RENDERER_FRAMEBUFFER_FRAMEBUFFERLAYOUT_HPP
#define COCKTAILENGINE_RENDERER_FRAMEBUFFER_FRAMEBUFFERLAYOUT_HPP
...
namespace Ck::Renderer
{
     ...
     * \return 
     */
	COCKTAILENGINE_RENDERER_API FramebufferLayout GetFramebufferLayout(const Framebuffer& renderTarget);
};

#endif // COCKTAILENGINE_RENDERER_RENDERTARGET_RENDERTARGETLAYOUT_HPP
