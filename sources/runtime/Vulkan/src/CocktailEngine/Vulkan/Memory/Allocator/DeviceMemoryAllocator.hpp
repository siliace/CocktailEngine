...
namespace Ck::Vulkan
{
	...
	private:
		...
		{
		    auto chunk = mChunkPool.Allocate(mRenderDevice, mBlockPool, resource, priority, memoryRequirements.size, memoryTypeIndex);
		...
		Array<ObjectPoolUniquePtr<DeviceMemoryChunk>> mChunks; /*!< List of active memory chunks */
