#ifndef COCKTAILENGINE_VULKAN_MEMORY_ALLOCATOR_DEVICEMEMORYBLOCK_HPP
#define COCKTAILENGINE_VULKAN_MEMORY_ALLOCATOR_DEVICEMEMORYBLOCK_HPP
...
namespace Ck::Vulkan
{
    ...
    public:
         ...
         */
        ObjectPoolUniquePtr<DeviceMemoryBlock> Split(ObjectPool<DeviceMemoryBlock>& blockPool, VkDeviceSize alignment, VkDeviceSize size);
...
#endif // COCKTAILENGINE_VULKAN_MEMORY_ALLOCATOR_DEVICEMEMORYBLOCK_HPP
