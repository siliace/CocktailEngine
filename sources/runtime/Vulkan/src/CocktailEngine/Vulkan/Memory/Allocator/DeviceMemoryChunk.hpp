#ifndef COCKTAILENGINE_VULKAN_MEMORY_ALLOCATOR_DEVICEMEMORYCHUNK_HPP
#define COCKTAILENGINE_VULKAN_MEMORY_ALLOCATOR_DEVICEMEMORYCHUNK_HPP

#include <CocktailEngine/Vulkan/Memory/DeviceMemory.hpp>
#include <CocktailEngine/Vulkan/Memory/Allocator/DeviceMemoryBlock.hpp>
...
namespace Ck::Vulkan
{
	...
	private:
		...
		Array<ObjectPoolUniquePtr<DeviceMemoryBlock>> mBlocks; /*!< List of sub-allocated memory blocks */
	};
}

#endif // COCKTAILENGINE_VULKAN_MEMORY_ALLOCATOR_DEVICEMEMORYCHUNK_HPP
