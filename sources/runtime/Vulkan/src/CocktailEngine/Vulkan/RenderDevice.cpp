...
#include <CocktailEngine/Vulkan/Buffer/BufferView.hpp>
#include <CocktailEngine/Vulkan/Command/Fence.hpp>
#include <CocktailEngine/Vulkan/Context/RenderContext.hpp>
...
#include <CocktailEngine/Vulkan/DescriptorSet/Allocator/DescriptorPool.hpp>
...
namespace Ck::Vulkan
{
	...
	{
		if (PipelineCacheSaver* pipelineCacheSaver = Resolve<PipelineCacheSaver>())
			pipelineCacheSaver->DumpPipelineCache();
	...
	{
		return mFramebufferPool.Allocate(this, Move(renderPass), createInfo, &mAllocationCallbacks);
	}
	...
	void RenderDevice::CreateInstance(AsciiStringView applicationName, const VersionDescriptor& applicationVersion, VulkanApiVersion apiVersion, bool enableValidationLayer)
	{
		VkApplicationInfo applicationInfo{ VK_STRUCTURE_TYPE_APPLICATION_INFO, nullptr };
		{
			...
			switch (apiVersion)
			{
			case VulkanApiVersion::Version_1_0:
				applicationInfo.apiVersion = VK_API_VERSION_1_0;
				break;

			case VulkanApiVersion::Version_1_1:
				applicationInfo.apiVersion = VK_API_VERSION_1_1;
				break;

			case VulkanApiVersion::Version_1_2:
				applicationInfo.apiVersion = VK_API_VERSION_1_2;
				break;

			case VulkanApiVersion::Version_1_3:
				applicationInfo.apiVersion = VK_API_VERSION_1_3;
				break;

			case VulkanApiVersion::Version_1_4:
