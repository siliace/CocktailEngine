#ifndef COCKTAILENGINE_VULKAN_DESCRIPTORSET_ALLOCATOR_DESCRIPTORSETALLOCATOR_HPP
#define COCKTAILENGINE_VULKAN_DESCRIPTORSET_ALLOCATOR_DESCRIPTORSETALLOCATOR_HPP

#include <CocktailEngine/Core/Utility/ObjectPool.hpp>

#include <CocktailEngine/Vulkan/DescriptorSet/DescriptorSetCreateInfo.hpp>
...
namespace Ck::Vulkan
{
	...
	private:
		...
		TlsSharedObjectPool<DescriptorSet> mDescriptorSetPool;
	};
}

#endif // COCKTAILENGINE_VULKAN_DESCRIPTORSET_ALLOCATOR_DESCRIPTORSETALLOCATOR_HPP
