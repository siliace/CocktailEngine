...
namespace Ck::Vulkan
{
	...
	private:
		...
		Array<ObjectPoolUniquePtr<BufferPool>, LinearAllocator<16>> mAcquiredBufferPools;
		Array<ObjectPoolUniquePtr<BufferPool>, LinearAllocator<16>> mAvailableBufferPools;
