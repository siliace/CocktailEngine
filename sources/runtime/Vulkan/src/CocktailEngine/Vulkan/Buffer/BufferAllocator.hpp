...
namespace Ck::Vulkan
{
	...
	private:
		...
		using BufferPoolPtr = TlsObjectPool<BufferPool>::Unique;
		...
		Array<BufferPoolPtr, LinearAllocator<16>> mAcquiredBufferPools;
		Array<BufferPoolPtr, LinearAllocator<16>> mAvailableBufferPools;
