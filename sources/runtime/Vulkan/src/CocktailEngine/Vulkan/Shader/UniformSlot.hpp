#ifndef COCKTAILENGINE_VULKAN_SHADER_UNIFORMSLOT_HPP
#define COCKTAILENGINE_VULKAN_SHADER_UNIFORMSLOT_HPP
...
namespace Ck::Vulkan
{
	...
	public:
		 ...
		 * \param name 
		 */
		UniformSlot(Renderer::ShaderProgramType programType, const Array<BlockMember>& members, AsciiString name, const DescriptorSetLayoutBinding& layoutBindingInfo, unsigned int set);
...
#endif // COCKTAILENGINE_VULKAN_SHADER_UNIFORMSLOT_HPP
