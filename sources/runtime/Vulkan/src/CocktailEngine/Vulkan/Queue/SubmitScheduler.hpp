...
namespace Ck::Vulkan
{
	...
	private:
		...
		Array<ObjectPoolUniquePtr<QueueSubmitBatch>> mBatches;
		Array<ObjectPoolUniquePtr<QueueSubmitBatch>> mPending;
		Array<ObjectPoolUniquePtr<QueueSubmitBatch>> mTerminated;
