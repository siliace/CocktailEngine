...
namespace Ck::Vulkan
{
	Texture::Texture(RenderDevice* renderDevice, const Renderer::TextureCreateInfo& createInfo, const VkAllocationCallbacks* allocationCallbacks) :
        ...
        mMemoryType(createInfo.ResourceMemoryType),
		...
		mAllocationCallbacks(allocationCallbacks)
	{
		...
		VkImageCreateInfo vkCreateInfo{ VK_STRUCTURE_TYPE_IMAGE_CREATE_INFO, nullptr };
		{
			...
			vkCreateInfo.tiling = createInfo.ResourceMemoryType == Renderer::MemoryType::Static ? VK_IMAGE_TILING_OPTIMAL : VK_IMAGE_TILING_LINEAR;
