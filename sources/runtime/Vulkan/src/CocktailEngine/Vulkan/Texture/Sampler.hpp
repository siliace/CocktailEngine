#ifndef COCKTAILENGINE_VULKAN_TEXTURE_SAMPLER_HPP
#define COCKTAILENGINE_VULKAN_TEXTURE_SAMPLER_HPP

#include <CocktailEngine/Renderer/Texture/Sampler.hpp>
...
#endif // COCKTAILENGINE_VULKAN_TEXTURE_SAMPLER_HPP
