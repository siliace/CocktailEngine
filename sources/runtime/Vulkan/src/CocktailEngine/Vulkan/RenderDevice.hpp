...
namespace Ck::Vulkan
{
	...
	private:
		...
		VkDevice mHandle;
		SharedObjectPool<Buffer> mBufferPool;
		SharedObjectPool<BufferView> mBufferViewPool;
		SharedObjectPool<CommandList> mCommandListPool;
		SharedObjectPool<ComputePipeline> mComputePipelinePool;
		SharedObjectPool<DescriptorPool> mDescriptorPoolPool;
		SharedObjectPool<DescriptorSetLayout> mDescriptorSetLayoutPool;
		SharedObjectPool<DescriptorUpdateTemplate> mDescriptorUpdateTemplatePool;
		SharedObjectPool<DeviceMemory> mDeviceMemoryPool;
		SharedObjectPool<Fence> mFencePool;
		SharedObjectPool<Framebuffer> mFramebufferPool;
		SharedObjectPool<GraphicPipeline> mGraphicPipelinePool;
		SharedObjectPool<PipelineLayout> mPipelineLayoutPool;
		SharedObjectPool<RenderBuffer> mRenderBufferPool;
		SharedObjectPool<RenderContext> mRenderContextPool;
		SharedObjectPool<RenderPass> mRenderPassPool;
		SharedObjectPool<RenderSurface> mRenderSurfacePool;
		SharedObjectPool<Sampler> mSamplerPool;
		SharedObjectPool<Semaphore> mSemaphorePool;
		SharedObjectPool<Shader> mShaderPool;
		SharedObjectPool<ShaderProgram> mShaderProgramPool;
		SharedObjectPool<Swapchain> mSwapchainPool;
		SharedObjectPool<Texture> mTexturePool;
		SharedObjectPool<TextureView> mTextureViewPool;
