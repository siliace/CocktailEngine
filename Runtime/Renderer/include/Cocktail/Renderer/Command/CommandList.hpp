...
namespace Ck::Renderer
{
    ...
    public:
        ...
        virtual void GenerateMipMaps(const Texture* texture, const TextureSubResource& subResource) = 0;
        ...
        virtual void BindUniformBuffer(UniformSlot* slot, unsigned int arrayIndex, const Buffer* uniformBuffer, std::size_t offset, std::size_t range) = 0;

        virtual void UpdateBuffer(const Buffer* buffer, std::size_t offset, std::size_t length, const void* data) = 0;
        ...
        virtual void SetBlendingConstants(const RgbaColor<float>& BlendingConstants) = 0;
