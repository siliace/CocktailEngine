...
namespace Ck::Renderer
{
	...
	public:
		 ...
		 */
		virtual void ExecuteCommandLists(CommandQueueType queue, unsigned int commandListCount, Ref<CommandList>* commandLists, const Ref<Fence>& fence) = 0;
		 ...
		 * \return
		 */
		virtual Signal<FrameContext*>& OnBeforeRedraw() = 0;

		/**
		 * \brief 
		 * \return 
		 */
		virtual Signal<FrameContext*, const Framebuffer*>& OnRedraw() = 0;
	};
}
