...
namespace Ck
{
    ...
    PixelFormat PixelFormat::DepthStencil(unsigned int depthBits, unsigned int stencilBits)
    {
        if (depthBits)
        {
            if (stencilBits)
            {
                Channel channels[2] = { { depthBits, false, true }, { stencilBits, true, false } };
    ...
    PixelFormat PixelFormat::FromImageRawFormat(ImageRawFormat::Type imageRawFormat, GammaSpace gammaSpace)
    {
        Encoding encoding = gammaSpace == GammaSpace::Linear ? Encoding::Normalized : Encoding::Raw;
        switch (imageRawFormat)
        {
            case ImageRawFormat::Type::Grey8: return Color(Layout::R, DataType::UnsignedInt8, Encoding::Normalized);
            case ImageRawFormat::Type::Grey16: return Color(Layout::R, DataType::UnsignedInt16, Encoding::Normalized);
            case ImageRawFormat::Type::Grey32F: return Color(Layout::R, DataType::Float32, Encoding::Normalized);
            case ImageRawFormat::Type::GreyAlpha8: return Color(Layout::RG, DataType::UnsignedInt8, Encoding::Normalized);
            case ImageRawFormat::Type::GreyAlpha16: return Color(Layout::RG, DataType::UnsignedInt16, Encoding::Normalized);
            case ImageRawFormat::Type::GreyAlpha32F: return Color(Layout::RG, DataType::Float32, Encoding::Normalized);
            case ImageRawFormat::Type::RedGreenBlue8: return Color(Layout::RGB, DataType::UnsignedInt8, encoding);
            case ImageRawFormat::Type::RedGreenBlue16: return Color(Layout::RGB, DataType::UnsignedInt16, Encoding::Normalized);
            case ImageRawFormat::Type::RedGreenBlue32F: return Color(Layout::RGB, DataType::Float32, Encoding::Normalized);
            case ImageRawFormat::Type::RedGreenBlueAlpha8: return Color(Layout::RGBA, DataType::UnsignedInt8, encoding);
            case ImageRawFormat::Type::RedGreenBlueAlpha16: return Color(Layout::RGBA, DataType::UnsignedInt16, Encoding::Normalized);
            case ImageRawFormat::Type::RedGreenBlueAlpha32F: return Color(Layout::RGBA, DataType::Float32, Encoding::Normalized);
        }
    ...
    unsigned PixelFormat::GetChannelCount() const
    {
        switch (mLayout)
        {
            case Layout::None: return 0;

            case Layout::R:
            case Layout::Depth:
            case Layout::Stencil: return 1;

            case Layout::RG:
            case Layout::DepthStencil: return 2;

            case Layout::RGB:
            case Layout::BGR: return 3;

            case Layout::RGBA:
            case Layout::BGRA:
            case Layout::ARGB:
            case Layout::ABGR: return 4;
        }
    ...
    {
        return mLayout != Layout::Depth && mLayout != Layout::Stencil && mLayout != Layout::DepthStencil;
    }
    ...
    bool PixelFormat::operator==(const PixelFormat& rhs) const
    {
        ...
        for (unsigned int i = 0; i < GetChannelCount(); i++)
        {
            ...
            if (std::tie(lhsChannel.Length, lhsChannel.IsUnsigned, lhsChannel.IsFloatingPoint) != std::tie(rhsChannel.Length, rhsChannel.IsUnsigned, rhsChannel.IsFloatingPoint))
                return false;
        }
