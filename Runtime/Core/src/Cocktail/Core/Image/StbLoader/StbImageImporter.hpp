...
namespace Ck
{
	 ...
	 * \brief 
	 */
	class StbImageImporter : public Inherit<StbImageImporter, Object, AssetImporter<Image, ImageImportParameters>>
	{
	public:
		 ...
		 * \return 
		 */
		Ref<Image> LoadFromPath(const std::filesystem::path& path, const ImageImportParameters& parameters) const override;
		 ...
		 * \return 
		 */
		Ref<Image> LoadFromStream(const Ref<InputStream>& inputStream, const ImageImportParameters& parameters) const override;
		 ...
		 * \return 
		 */
		Ref<Image> LoadFromMemory(const void* buffer, std::size_t length, const ImageImportParameters& parameters) const override;
