...
namespace Ck::Detail::Win32
{
	 ...
	 * \brief
	 */
	class LocalFileSystemDriver : public Inherit<LocalFileSystemDriver, Object, Ck::LocalFileSystemDriver>
	{
	public:
		 ...
		 */
		LocalFileSystemDriver(std::filesystem::path location, bool followLink, bool lazyRootCreation);
