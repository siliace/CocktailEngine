#ifndef COCKTAIL_CORE_SYSTEM_CLIPBOARD_WIN32_CLIPBOARDSERVICE_HPP
#define COCKTAIL_CORE_SYSTEM_CLIPBOARD_WIN32_CLIPBOARDSERVICE_HPP
...
{
    class ClipboardService : public Inherit<ClipboardService, Object, Ck::ClipboardService>
    {
    public:
...
#endif // COCKTAIL_CORE_SYSTEM_CLIPBOARD_WIN32_CLIPBOARDSERVICE_HPP
