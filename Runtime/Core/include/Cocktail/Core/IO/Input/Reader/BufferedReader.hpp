...
namespace Ck
{
	 ...
	 * \brief 
	 */
	class COCKTAIL_CORE_API BufferedReader : public Inherit<BufferedReader, Object, Reader>
	{
	public:
		 ...
		 * \param bufferSize 
		 */
		explicit BufferedReader(const Ref<Reader>& reader, std::size_t bufferSize = DefaultBufferSize);
