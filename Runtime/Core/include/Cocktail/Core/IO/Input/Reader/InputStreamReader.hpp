...
namespace Ck
{
	class COCKTAIL_CORE_API InputStreamReader : public Inherit<InputStreamReader, Object, Reader>
	{
	public:

		explicit InputStreamReader(const Ref<InputStream>& inputStream);
