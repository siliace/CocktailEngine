...
#define COCKTAIL_DECLARE_EXCEPTION_FROM(__Name, __Base)                                               \
	...
	public:                                                                                           \
		...
		static String FormatExceptionMessage(StringView format, Args&&... args)                       \
		{                                                                                             \
			return CK_TEXT("WTF");                                                                    \
		}                                                                                             \
		                                                                                              \
		__Name() = default;                                                                           \
		                                                                                              \
		explicit __Name(String message) :                                                             \
			__Base(std::move(message))                                                                \
		{                                                                                             \
		}                                                                                             \
		                                                                                              \
		 __Name(const ::Ck::Exception& nested, String message) :                                      \
			__Base(nested, std::move(message))                                                        \
		{                                                                                             \
		}                                                                                             \
                                                                                                      \
		template <typename... Args>                                                                   \
		explicit __Name(StringView format, Args&&... args) :                                          \
			__Base(FormatExceptionMessage(format, std::forward<Args>(args)...))                       \
		{		                                                                                      \
		}                                                                                             \
                                                                                                      \
		template <typename... Args>                                                                   \
		explicit __Name(const ::Ck::Exception& nested, StringView format, Args&&... args) :           \
			__Base(nested, FormatExceptionMessage(format, std::forward<Args>(args)...))               \
		{		                                                                                      \
		}                                                                                             \
                                                                                                      \
		StringView GetName() const override { return CK_TEXT(#__Name); }                              \
                                                                                                      \
	protected:                                                                                        \
