...
namespace Ck
{
	...
	public:
		...
		static void Instance(const Ref<Concrete>& instance)
		{
			ResolveFacadeInstance()->Instance<Concrete>(instance);
		}
		 ...
		 */
		static void RegisterServiceProvider(const Ref<ServiceProvider>& serviceProvider);
