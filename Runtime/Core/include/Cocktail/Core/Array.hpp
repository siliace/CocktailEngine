...
namespace Ck
{
    COCKTAIL_DECLARE_EXCEPTION_BASE(ArrayEmpty, "Array is empty", std::runtime_error);
    COCKTAIL_DECLARE_EXCEPTION_BASE(ArrayOutOfRange, "Array subscript has been out of range", std::runtime_error);
