...
namespace Ck
{
	 ...
	 * \brief 
	 */
	class ConsoleService : public Implements<ConsoleService, Interface>
	{
	public:
		 ...
		 * \return 
		 */
		virtual Ref<Writer> GetOutput() = 0;

		/**
		 * \brief
		 * \return
		 */
		virtual Ref<Writer> GetError() = 0;

		/**
		 * \brief 
		 * \return 
		 */
		virtual Ref<Reader> GetInput() = 0;
