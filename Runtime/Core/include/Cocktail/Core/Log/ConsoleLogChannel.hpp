...
namespace Ck
{
	 ...
	 * \brief 
	 */
	class COCKTAIL_CORE_API ConsoleLogChannel : public Extends<ConsoleLogChannel, LogChannel>
	{
	public:
		 ...
		 * \param console 
		 */
		explicit ConsoleLogChannel(Ref<ConsoleService> console);
