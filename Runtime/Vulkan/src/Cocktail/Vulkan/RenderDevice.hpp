...
namespace Ck::Vulkan
{
	 ...
	 * \brief 
	 */
	class RenderDevice : public Inherit<RenderDevice, ServiceContainer, Renderer::RenderDevice>
	{
	public:
		 ...
		 * \return 
		 */
		Signal<Renderer::MessageType, std::string_view>& OnDebugMessage() override;
	...
	private:
		...
		Signal<Renderer::MessageType, std::string_view> mOnDebugMessage;
	};
}
