...
namespace Ck::Vulkan
{
	Semaphore::Semaphore(const Ref<RenderDevice>& renderDevice, const SemaphoreCreateInfo& createInfo, const VkAllocationCallbacks* allocationCallbacks) :
	...
	Ref<Renderer::RenderDevice> Semaphore::GetRenderDevice() const
	{
