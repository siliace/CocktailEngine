...
namespace Ck::Vulkan
{
	 ...
	 * \brief 
	 */
	class DeviceMemoryAllocator : public Extends<DeviceMemoryAllocator, Object>
	{
	public:
		 ...
		 * \return 
		 */
		DeviceMemoryBlock* Allocate(AbstractTexture* texture);
		 ...
		 * \return 
		 */
		DeviceMemoryBlock* Allocate(Buffer* buffer);
