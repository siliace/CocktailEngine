...
namespace Ck::Vulkan
{
	...
	public:
		...
		void UpdateBuffer(const Renderer::Buffer* buffer, std::size_t offset, std::size_t length, const void* data) override;
	...
	private:
		...
		DepthStencilResolverHelper mDepthStencilResolver;
	};
}
