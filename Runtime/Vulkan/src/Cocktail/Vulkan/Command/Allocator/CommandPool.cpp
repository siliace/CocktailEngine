...
namespace Ck::Vulkan
{
	CommandPool::CommandPool(RenderDevice* renderDevice, const CommandPoolCreateInfo& createInfo, const VkAllocationCallbacks* allocationCallbacks):
	...
	Renderer::RenderDevice* CommandPool::GetRenderDevice() const
	{
