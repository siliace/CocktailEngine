...
namespace Ck::Vulkan
{
	...
	void DepthResolver::Resolve(Renderer::CommandList& commandList, Ref<Renderer::TextureView> multisampleAttachment, Ref<Renderer::TextureView> attachment, Renderer::ResolveMode depthResolveMode)
	{
