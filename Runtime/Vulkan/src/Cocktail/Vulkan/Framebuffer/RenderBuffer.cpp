...
namespace Ck::Vulkan
{
	RenderBuffer::RenderBuffer(const Ref<RenderDevice>& renderDevice, const RenderBufferCreateInfo& createInfo, const VkAllocationCallbacks* allocationCallbacks) :
		Extends<RenderBuffer, AbstractTexture>(renderDevice),
