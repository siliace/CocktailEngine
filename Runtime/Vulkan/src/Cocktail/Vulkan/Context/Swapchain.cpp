...
namespace Ck::Vulkan
{
	Swapchain::Swapchain(const Ref<RenderDevice>& renderDevice, const SwapchainCreateInfo& createInfo, const VkAllocationCallbacks* allocationCallbacks):
		mRenderDevice(renderDevice),
		mAllocationCallbacks(allocationCallbacks),
		mHandle(VK_NULL_HANDLE)
	{
		VkPhysicalDevice physicalDevice = renderDevice->GetPhysicalDeviceHandle();
