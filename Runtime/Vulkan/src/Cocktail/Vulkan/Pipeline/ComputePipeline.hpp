...
namespace Ck::Vulkan
{
	...
	public:
		 ...
		 */
		ComputePipeline(const Ref<RenderDevice>& renderDevice, const Ref<PipelineCache>& pipelineCache, const ComputePipelineCreateInfo& createInfo, const VkAllocationCallbacks* allocationCallbacks);
