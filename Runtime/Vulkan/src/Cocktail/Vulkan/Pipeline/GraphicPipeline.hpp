...
namespace Ck::Vulkan
{
	...
	public:
		 ...
		 */
		GraphicPipeline(const Ref<RenderDevice>& renderDevice, const Ref<PipelineCache>& pipelineCache, const GraphicPipelineCreateInfo& createInfo, const VkAllocationCallbacks* allocationCallbacks);
