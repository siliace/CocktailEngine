...
namespace Ck::Vulkan
{
	GraphicPipeline::GraphicPipeline(const Ref<RenderDevice>& renderDevice, const Ref<PipelineCache>& pipelineCache, const GraphicPipelineCreateInfo& createInfo, const VkAllocationCallbacks* allocationCallbacks) :
		Super(renderDevice),
		...
		mHandle(VK_NULL_HANDLE)
	{
		...
		VkPipelineColorBlendStateCreateInfo vkPipelineColorBlendState{ VK_STRUCTURE_TYPE_PIPELINE_COLOR_BLEND_STATE_CREATE_INFO, nullptr };
		{
			...
			vkPipelineColorBlendState.blendConstants[0] = colorBlendState.BlendConstants.Red / 255.f;
			vkPipelineColorBlendState.blendConstants[1] = colorBlendState.BlendConstants.Green / 255.f;
			vkPipelineColorBlendState.blendConstants[2] = colorBlendState.BlendConstants.Blue / 255.f;
			vkPipelineColorBlendState.blendConstants[3] = colorBlendState.BlendConstants.Alpha / 255.f;
		}
	...
	Ref<PipelineLayout> GraphicPipeline::GetLayout() const
	{
		return mLayout;
	}
