...
namespace Ck::D3D12
{
    ...
    void CommandList::BindTexture(const Renderer::UniformSlot* slot, unsigned int arrayIndex, const Renderer::TextureView* textureView)
    {
    }

    void CommandList::BindBuffer(const Renderer::UniformSlot* slot, unsigned int arrayIndex, const Renderer::Buffer* uniformBuffer, std::size_t offset, std::size_t range)
    {
    }
    ...
    {
        return Renderer::CommandListState::Initial;
    }

    Renderer::CommandListUsageBits CommandList::GetUsage() const
    {
        return Renderer::CommandListUsageBits::Graphic;
    }
