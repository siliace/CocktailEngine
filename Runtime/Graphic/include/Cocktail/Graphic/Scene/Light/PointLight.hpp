...
namespace Ck
{
	...
	public:
		 ...
		 * \return 
		 */
		static PointLight* Create(std::shared_ptr<Scene> scene, LinearColor color = LinearColor(1.f, 1.f, 1.f), Vector3<float> position = Vector3<float>::Zero(), float intensity = 100.f);
