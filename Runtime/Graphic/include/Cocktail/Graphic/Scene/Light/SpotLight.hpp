...
namespace Ck
{
	...
	public:
		 ...
		 * \return
		 */
		static Ref<SpotLight> Create(Ref<Scene> scene, LinearColor color, Vector3<float> direction, Vector3<float> position);
		 ...
		 * \param direction
		 */
		SpotLight(Ref<TransformationNode> transformationNode, LinearColor color, Vector3<float> direction);
