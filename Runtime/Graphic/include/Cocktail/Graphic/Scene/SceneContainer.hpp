...
namespace Ck
{
	...
	public:
		 ...
		 * \return 
		 */
		Ref<SceneNode> AddToScene(Ref<Scene> scene);
	...
	private:
		 ...
		 * \return 
		 */
		Ref<SceneNode> ProcessNode(const Ref<GraphicEngine>& graphicEngine, const Ref<Scene>& scene, Ref<SceneNode> parent, NodeInfo& nodeInfo, const std::vector<Ref<Material>>& materials);
	};
}
