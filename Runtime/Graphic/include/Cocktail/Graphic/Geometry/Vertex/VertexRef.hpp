...
namespace Ck
{
	...
	public:
		 ...
		 */
		template <typename T>
		void Set(VertexAttributeSemantic semantic, const Vector2<T>& value)
		{
			Set<T>(semantic, static_cast<const T*>(value), 2);
		}
		 ...
		 */
		template <typename T>
		void Set(VertexAttributeSemantic semantic, const Vector3<T>& value)
		{
			Set<T>(semantic, static_cast<const T*>(value), 3);
		}
		 ...
		 */
		template <typename T>
		void Set(VertexAttributeSemantic semantic, const Vector4<T>& value)
		{
			Set<T>(semantic, static_cast<const T*>(value), 4);
		}
