...
namespace Ck
{
	...
	public:
		...
		{
			RgbaColor<float> Base;
			RgbaColor<float> Specular;
			RgbaColor<float> Emission;
		};
		 ...
		 * \param color
		 */
		void SetSpecularColor(const RgbaColor<float>& color);

		/**
		 * \brief
		 * \param color
		 */
		void SetEmissiveColor(const RgbaColor<float>& color);
