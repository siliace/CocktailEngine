...
namespace Ck
{
	...
	public:
		...
		{
			alignas(16) RgbaColor<float> Base;
			alignas(16) RgbColor<float> Specular;
			alignas(16) RgbColor<float> Emission;
		};
		 ...
		 * \param color
		 */
		void SetBaseColor(const RgbaColor<float>& color);

		/**
		 * \brief
		 * \param color
		 */
		void SetSpecularColor(const RgbColor<float>& color);

		/**
		 * \brief
		 * \param color
		 */
		void SetEmissiveColor(const RgbColor<float>& color);
