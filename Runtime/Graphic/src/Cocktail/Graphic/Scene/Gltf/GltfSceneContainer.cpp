...
namespace Ck
{
    namespace
    {
        ...
        LinearColor ToLinearColor(const std::vector<double>& values)
        {
            LinearColor color;
    ...
    SceneContainer::MaterialInfo GltfSceneContainer::ProcessMaterial(const tinygltf::Model& model, const tinygltf::Material& gltfMaterial)
    {
        ...
        materialInfo.Colors.Base = ToLinearColor(gltfMaterial.pbrMetallicRoughness.baseColorFactor);
        materialInfo.Colors.Emission = ToLinearColor(gltfMaterial.emissiveFactor);
