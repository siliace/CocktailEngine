...
namespace Ck
{
    ...
    namespace
    {
        ...
        public:
            ...
            static UniquePtr<Renderer::RenderDevice> CreateD3D12RenderDevice()
            {
                return D3D12::CreateRenderDevice();
            }
    ...
    GraphicEngine::GraphicEngine(Renderer::GraphicApi api)
    {
        switch (api)
        {
            case Renderer::GraphicApi::Direct3D12: mRenderDevice = RenderDeviceFactory::CreateD3D12RenderDevice(); break;
            case Renderer::GraphicApi::Vulkan: mRenderDevice = RenderDeviceFactory::CreateVulkanRenderDevice(GraphicEngine_EnableDebug); break;
