...
namespace Ck
{
	...
	void GraphicEngine::FlushTransfer()
	{
		...
		{
			Renderer::CommandList* commandList = mRenderContext->CreateCommandList({ Renderer::CommandListUsage::Transfer });
		...
		{
			Renderer::CommandList* commandList = mRenderContext->CreateCommandList({ Renderer::CommandListUsage::Graphic });
